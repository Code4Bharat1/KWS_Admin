      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className={`hidden md:flex space-x-16 justify-center flex-1`}>
            ...
            <div className="relative">
              ...
              {activeDropdown === "members" && (
                <div className="absolute top-full mt-2 w-48 bg-white text-black rounded-lg shadow-lg">
          ...
          <div className={`hidden md:flex items-center space-x-6`}>
            ...
            <button
              ...
              className="flex flex-col items-center text-black text-sm font-medium hover:text-red-500"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-green-400 text-white p-4 space-y-4">
            ...
            <div>
              ...
              {activeDropdown === "members" && (
                <div className="bg-white text-black p-2 rounded-lg shadow-lg">
                  ...
                  <Link href="/members/review" className="block py-2 hover:bg-gray-100">
                    Membership Review
                  </Link>
                  <Link href="/members/info-update" className="block py-2 hover:bg-gray-100">
                    Info Update Request
                  </Link>
                  <Link href="/members/non-kws" className="block py-2 hover:bg-gray-100">
                    Non-KWS Account
                  </Link>
                  <Link href="/members/failed-emails" className="block py-2 hover:bg-gray-100">
                    Failed Emails
                  </Link>
                </div>
              )}
            ...
            <button
              onClick={() => alert("Logging out...")}
              className="block py-2 text-sm font-medium hover:text-red-500"
            >
