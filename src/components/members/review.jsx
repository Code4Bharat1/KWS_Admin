...
const Review = () => {
  ...
  const handleRemoveImage = (indexToRemove) => {
    setFormData((prevData) => ({
      ...prevData,
      form_scanned: prevData.form_scanned.filter(
  ...
  const handleReviewClick = async (userId) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BACKEND_API_KEY}/auth/get/${userId}`
      );
        ...
        <div className="mt-6 bg-gray-50 p-6 rounded-lg shadow-md">
          ...
          <form>
            ...
            <div className="mt-6 flex flex-col items-center">
              ...
              {errorMessage.includes("Profile picture") && (
            ...
            <div className="mb-6">
              <h3 className="text-2xl mt-2 text-gray-800 font-semibold mb-4">
                Address (India)
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label
                    htmlFor="indianAddress"
                    className="block text-sm font-medium text-gray-700"
                  >
              ...
              <div className="mb-6">
                <h3 className="text-4xl mb-4 text-center border-b-4 border-black">
                  Office Use
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label
                      ...
                      className="block text-sm font-medium text-gray-700"
                    >
                      Upload a scanned copy of the physical KWS form (old
                      members)
                    </label>
                    <input
                      type="file"
                    ...
                    <div className="mt-4">
                      {formData.form_scanned instanceof File ? (
                        ...
                        <p className="text-gray-500">
                          No scanned form uploaded.
                        </p>
                      )}
                      {errorMessage.includes("Scanned form") && (
